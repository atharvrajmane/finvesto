...
function Brokerage() {
  return (
    <div className="container p-4 mt-5 mb-5 px-5">
      <div className="row mt-5 pt-5 mx-auto px-5">
        ...
        <h2 className="fs-4 mt-2 mb-5">Charges explained</h2>
        ...
        <div className="col-6 ps-4">
          ...
          <p className="innertext">₹30 + GST per pledge request per ISIN.</p>
          ...
          <p className="innertext">₹25 per transaction.</p>
